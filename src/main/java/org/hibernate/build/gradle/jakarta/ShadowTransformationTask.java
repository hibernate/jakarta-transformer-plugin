 ...
 */
public abstract class ShadowTransformationTask
		extends DefaultTask
	...
	@Inject
	public ShadowTransformationTask(
...
//		shadowPublication.from( component );
	...
	private RegularFile transform(ResolvedDependency dependency) {
		...
		getProject().getLogger().lifecycle( "Transforming `{}` -> `{}`", sourceArtifact.getName(), transformedArtifactName );
